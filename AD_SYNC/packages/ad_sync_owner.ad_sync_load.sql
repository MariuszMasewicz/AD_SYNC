...
procedure add_user_to_load (p_username varchar2, p_REQUESTED_OPERATION char default 'C');
...
procedure add_user_to_load (p_username varchar2, p_REQUESTED_OPERATION char default 'C') is   
begin
INSERT INTO ad_sync_owner.ad_sync_users (username, REQUESTED_OPERATION) VALUES (upper(p_username), upper(p_REQUESTED_OPERATION));
commit;
  EXCEPTION
    WHEN OTHERS THEN
      ad_sync_owner.ad_sync_log.write_error($$PLSQL_UNIT ||
