...
grant select on sys.dba_users to ad_sync_owner;
grant select on sys.dba_roles to ad_sync_owner;
grant select on sys.dba_role_privs to ad_sync_owner;
grant select on sys.role_role_privs to ad_sync_owner;
