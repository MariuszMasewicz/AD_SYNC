...
prompt CREATE SEQUENCE ad_sync_owner.ad_sync_users_for_services_SEQ;

CREATE SEQUENCE AD_SYNC_OWNER.AD_SYNC_USERS_FOR_SERVICES_SEQ;

prompt CREATE SEQUENCE ad_sync_owner.AD_SYNC_GROUPS_SEQ;

CREATE SEQUENCE AD_SYNC_OWNER.AD_SYNC_GROUPS_SEQ;

prompt CREATE SEQUENCE ad_sync_owner.AD_SYNC_GROUP_PERMISSION_SEQ;

CREATE SEQUENCE AD_SYNC_OWNER.AD_SYNC_GROUP_PERMISSION_SEQ;
...
prompt CREATE SEQUENCE ad_sync_owner.AD_SYNC_GROUP_TABLESPACE_QUOTAS_SEQ;

CREATE SEQUENCE AD_SYNC_OWNER.AD_SYNC_GROUP_TABLESPACE_QUOTAS_SEQ;